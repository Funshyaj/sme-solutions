...
<div className="flex flex-col justify-start pr-3 md:pr-48  lg:pr-[31rem] md:pl-10 lg:pt-12 gap-3 z-[2]">
    <h1 className="text-4xl text-[#0e0e52] font-medium md:text-5xl lg:text-6xl font-head">
...
<div className="absolute top-[45%] md:top-[40%] lg:top-[15%] right-4 w-full z-[1]">
...
<section className="-mt-1">
    ...
    <div className="absolute  nl:top-[40%] nxl:top-[30%]  left-[25%] top-[48%]  lg:top-0 z-0 w-full md:top-[10%] md:left-[50%]"> 
...
<section className="bg-[#3943b7] py-8 px-2  md:h-[100vh] mt-5 ">
    ...
    <div className="pr-16 z-[1]  md:pr-[21rem]"> 
        <h2 className="text-[#0e0e52] text-3xl font-medium font-head md:text-4xl pb-5">Register Your Business</h2>
        <p className="text-base md:text-xl text-[#0e0e2d]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci eius, rerum voluptas voluptate facilis inventore deleniti, assumenda itaque aut sed optio esse nostrum asperiores similique. Provident vel nihil quas vitae.</p>
    </div>
    <div className="pb-16 z-[1] pl-5">
